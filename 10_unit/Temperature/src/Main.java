public class Main {
    public static void main(String[] args) {
        float [] patientTem = new float[30];
        Report report = new Report();
        report.getReport(patientTem);

    }
}
//Напишите код метода generatePatientsTemperatures(), который должен
// сгенерировать массив float, содержащий значения температур пациентов от 32 до 40 градусов.

//В методе getReport()вам требуется составить строку с отчётом
// по значениям температур в массиве с пациентами:
